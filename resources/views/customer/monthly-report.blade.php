...
<div class="container-fluid">
      ...
      <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Monthly Report</h2>
            <ol class="breadcrumb">
                      ...
                      <!--  <span class="float-right">
                        ...
                        <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="userid">Customers</label>
                                        <select class="form-control js-example-basic-single"  name="customerid" id="customerid">
                                            <option value="">Select Customer</option>
                                            @if($users)
                                            @foreach($users as $user)
                                             <option value="{{$user->id}}">{{$user->name}} (CIF:{{$user->cif_no}} | Account:{{$user->account_no}})</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div> 
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-date" value="" name="date" id="date">
                                    </div> 
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                    ...
                    <table id="exportexample1" class="table-bordered text-nowrap mb-0 table table-bordered border-t0 key-buttons text-nowrap w-100" >
                        <thead>
                            <tr>
                                ...
                                <th>Closing Bal.</th>
                                <th>Opening Bal.</th>
                                <th>Amount Deposit PO.</th>
                                <th>PO Closing Bal.</th>
                                <th>PO Opening Bal.</th>
                                <th>PO payment Month</th>
                                <th>Admin Balance</th>
                                <th>Month</th>
                                <th>Action</th>
                            </tr>
